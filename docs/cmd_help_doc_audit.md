...
Audit all documentation for structural issues.
  ...
  [no param]      Scan docs/**/*.md (recursive, excluding docs/xxArchive/), xTrack/*/FEAT_DOC_*.md,
                  xTrack/*/FEAT_PLN_*.md.
                  Report:
                  ...
                  (c) docs with invalid scope (not core|onboarding|feature|reference) — retirement
                      goes through #archive, never a scope tag
