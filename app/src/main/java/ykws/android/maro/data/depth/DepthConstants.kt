...
object DepthConstants {
    ...
    /** Water-only fetch extent (Cannes / Lérins; tune on device). lat S/N, lon W/E. */
    val WATER_BBOX = BoundingBox(latSouth = 43.40, latNorth = 43.57, lonWest = 6.90, lonEast = 7.20)
