...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("int", "TRACKING_OPACITY_FROM", propInt("tracking.opacity.from", 80).toString())
        buildConfigField("int", "TRACKING_OPACITY_TO", propInt("tracking.opacity.to", 20).toString())
        buildConfigField("int", "TRACKING_OPACITY_PINNED_FROM", propInt("tracking.opacity.pinnedFrom", 100).toString())
        buildConfigField("int", "TRACKING_OPACITY_PINNED_TO", propInt("tracking.opacity.pinnedTo", 80).toString())
