...
- [x] Renamed `bake_*.bat` → `bake-*.bat`; updated `xTrack/DepthMapping/FEAT_DOC_DepthMapping_bake.md` (bake/build/deploy model, derived envelope, `data/app-assets` paths)
