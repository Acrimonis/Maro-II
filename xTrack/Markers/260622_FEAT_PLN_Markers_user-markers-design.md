...
Full list of all markers. **Delete uses the exact same paradigm as track list** (per [`260618_FEAT_PLN_Tracks_TrackList_Design.md`](xTrack/Tracks/260618_FEAT_PLN_Tracks_TrackList_Design.md)):
