...
- Historical references in other features' docs (`xTrack/Tracks/260620_FEAT_PLN_Tracks_settings-page-rules.md` R1, `xTrack/Markers/260703_FEAT_PLN_Markers_setting-markers.md`, `xTrack/Performance/FEAT_DOC_Performance_battery-design.md`) — reference-only, not edited here.
