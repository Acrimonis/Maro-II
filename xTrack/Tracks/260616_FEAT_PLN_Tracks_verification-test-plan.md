<!-- scope: feature -->
# Tracks — E2E Verification Test Plan
...
- All tests should be run with the debug APK built from the Tracks feature branch.
- Logcat filtering: `adb logcat -s TrackRecorder,TrackRepository,TracksViewModel`
