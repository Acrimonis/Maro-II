# Tracks Step 3 — UI Integration Implementation
...
Wire the Tracks recording subsystem into the Compose UI: map overlay rendering, settings controls, recording status icon, track drawer, track history screen, and GPX export.
