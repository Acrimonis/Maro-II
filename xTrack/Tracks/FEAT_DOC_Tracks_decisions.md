<!-- scope: feature -->
# Tracks — Functional Decisions Record

> **Purpose:** Capture every functional and architectural decision made during the Tracks feature.  
...
- **Rationale:** The PAUSED and FINALIZING states added complexity without user-facing benefit. `isStill()` gates point capture within ON state — recording never truly pauses, it just stops collecting points. See [`tracking-states-triggers` plan](260618_FEAT_PLN_Tracks_tracking-states-triggers.md).
