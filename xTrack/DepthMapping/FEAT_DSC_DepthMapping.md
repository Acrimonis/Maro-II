...
### DataValidation ← priority deliverable
...
- `xTrack/DepthMapping/260609_FEAT_PLN_DepthMapping_emodnet-gate-nodata-color.md` — design plan
...
- `xTrack/DepthMapping/260609_FEAT_PLN_DepthMapping_emodnet-gate-nodata-color.md` — EMODnet shallow gate + NoData colour plan
- `xTrack/DepthMapping/260610_FEAT_PLN_DepthMapping_litto3d-regression-analysis.md` — Litto3D missing-from-bake regression analysis + fix path
- `xTrack/DepthMapping/260609_FEAT_PLN_DepthMapping_oom-mmap-fix.md` — Depth OOM memory-mapped I/O fix practical steps
- `xTrack/DepthMapping/260609_FEAT_PLN_DepthMapping_intra-raster-progress.md` — Intra-raster progress fix plan for raster builders
