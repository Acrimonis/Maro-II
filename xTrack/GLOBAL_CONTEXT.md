...
## Focus History
- [2026-09-10 11:23 UTC] Ui_Settings — C12 OverlayLayer param collapse on feature/refact-C12: tiers 1a-i/1a-ii committed (ec57458) and 1b landed — OverlayChrome (7) + MenuOverlayData (12) + SettingsOverlayData (5) + TrackInfoOverlayData (4) in new OverlayLayerParams.kt; OverlayLayer 89→65 params; 28-line destructure keeps the body unchanged; builds SUCCESS zero warnings; Ask 8/8 + 8/8, tier 1b proven by pre-image git diff (ScrollState pairings); R10 metric waived in writing; remaining 1c + citation pass → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
