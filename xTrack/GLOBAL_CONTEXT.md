...
## Focus History
- [2026-09-09 16:17 UTC] Ui_Settings — MapScreen orchestration-monolith refactor step 2 on feature/mapscreen-refactor: C1–C9 extracted (MapGpsFollow/MapTrackOverlay/MapMarker/MapService/MapDepthRaster/MapDialogHost seam files); MapDialogHost wired (was dead), inline dialog dupes removed; MapScreen.kt 3506→2641; apk-build SUCCESS; C10–C12 pending → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
...
- [2026-09-07 15:18 UTC] Ui_General — list-count-display implemented via #implement (Track History title "· N" + menu Tracks/Markers counts left of chevron, live excluded); Ask review PASS; build SUCCESS → xTrack/Ui_General/FEAT_HYD_Ui_General.md
- [2026-09-07 14:55 UTC] Ui_General — #focus ui lists: lists domain (ListOverlayScaffold, filter/sort, swipe-to-delete, list-detail navigation) → xTrack/Ui_General/FEAT_HYD_Ui_General.md
- [2026-09-07 14:48 UTC] Ui_Settings — finalise-feature: closed all remaining sections (render-tweaks already-implemented, header-normalization merged PR #217, apply-on-close out-of-scope); guideline docs verified in sync → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-07 14:36 UTC] Ui_Settings — portrait Track drawer tiny-scroll fix: render-measure-resize Prev/Next footer (MeasureHeight probe in single Column) → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-07 13:58 UTC] Ui_Settings — detail-drawer header fix: back button IconButton→32dp circle (min-size overflow clip), square top corners on Marker/Track drawers, ~6dp title→card gap → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-07 11:08 UTC] Ui_Settings — post-header spacing normalized to single 6dp gap across all drawers (ui.padding.header.vertical token; removed Menu 20dp, Marker 8dp+contentPadding top, Track contentPadding top ×2) → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-07 10:57 UTC] Ui_Settings — header-normalization follow-up: removed leftover 16dp spacer between Settings header and tab bar (tab bar follows header directly) → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-07 10:51 UTC] Ui_Settings — header-normalization implemented (Settings overlay header → shared DrawerHeader, no actions; guideline §6/§12 updated) → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-07 10:09 UTC] Ui_Settings — properties-normalization cleanup pass (A1 7 labels→16sp, A2/B4 BoatSizeSlider dead branch, A3 label.control token, A4 fallback fix, B1 8 dead tokens pruned, B2 doc refs, B6 zone.properties comment) → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-07 09:45 UTC] Ui_Settings — properties-normalization implemented (ui-tokens→ui.properties, wired into AppConfig, re-homed 6 keys, settings composables tokenized) → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-06 21:19 UTC] ArcLayout — control-stack button swap (Add Zone above layer fan) implemented → xTrack/ArcLayout/FEAT_HYD_ArcLayout.md
- [2026-09-06 21:13 UTC] Ui_Settings — global opacity→transparency normalization + low-depth 2-depth (crash/start) warning redesign implemented; ui-*guidelines docs aligned → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-06 11:25 UTC] Ui_Settings — marker "Belongs to track" bottom row + chevron (list + detail drawer) implemented → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-06 09:59 UTC] Ui_Settings — settings-misc branch: Card/Expander/NestedCard refactor + guideline consolidation implemented → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
- [2026-09-05 12:03 UTC] Ui_Settings — settings-misc branch: settings page UI, persistence, widgets, UX → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
