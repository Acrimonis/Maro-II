...
## Focus History
- [2026-09-11 12:17 UTC] Ui_Settings — row family normalization R1–R6 on feature/settings-menu-clean: R3–R5 (generic surface-free SegmentedRow + Arrow density, GPS frequency picker, CardDescription + 6 migrations, committed e954a48) and R6 (ToggleRow.leadingIcon; 13 inline Switch rows → ToggleRow; 3 dividers → SectionDivider, 4 deferred to R7; build SUCCESS no new warnings); R3/R4 device pass clean; R7–R8 pending → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
