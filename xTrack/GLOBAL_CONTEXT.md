...
## Focus History
- [2026-09-11 11:50 UTC] Ui_Settings — row family normalization R3–R5 on feature/settings-menu-clean: generic surface-free SegmentedRow (a11y group, optional captions) adopted at Language (now in a Card) + Arrow density, GPS frequency → 3-option picker (SettingsFrequencyRow deleted), CardDescription + 6 migrations; builds SUCCESS; R6–R8 pending → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
