...
## Focus History
- [2026-09-10 10:57 UTC] Ui_Settings — C12 OverlayLayer param collapse, tiers 1a-i + 1a-ii on feature/refact-C12: OverlayChrome (7) + MenuOverlayData (12) bundles in new OverlayLayerParams.kt; OverlayLayer 89→72 params; destructure-at-top keeps body unchanged; builds SUCCESS zero warnings; Ask 8/8 + 8/8; R10 metric waived in writing; remaining 1b/1c + citation pass → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
