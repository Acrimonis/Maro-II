...
## Focus History
- [2026-09-10 11:38 UTC] Ui_Settings — C12 OverlayLayer param collapse COMPLETE on feature/refact-C12: all six bundles landed (OverlayChrome 7, MenuOverlayData 12, SettingsOverlayData 5, TrackInfoOverlayData 4, TrackListOverlayData 3, MarkerListOverlayData 4) in new OverlayLayerParams.kt; OverlayLayer 89→60 params; 35-line destructure keeps the body unchanged; 2 dead rememberLazyListState defaults + orphan imports removed; builds SUCCESS zero warnings every tier; Ask 8/8 + 8/8, tiers 1b/1c proven by pre-image git diff; R10 metric waived in writing; ~30 stale line anchors repaired across 22 markdown files; awaiting on-device smoke → xTrack/Ui_Settings/FEAT_HYD_Ui_Settings.md
