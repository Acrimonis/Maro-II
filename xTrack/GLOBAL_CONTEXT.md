...
| Ui_Settings | Settings page UI — 4 tabs; Re-display on approach section (global GPS/demo + per-type switches + always-visible knobs); per-zone proximity reveal; drawer Position mode + Auto-show zones master switch; tab navigation swipe disabled + per-page slide spacing fixed; Card/Expander/NestedCard structural refactor (SettingsSliderGroup/Row deprecated); SectionDivider normalization; GPS freq/recenter shared NestedCard; component/drawer/lists guideline consolidation | 2026-06-09 15:28 | 2026-09-06 09:59 | active |
