...
- **Last Bake:** 2026-07-14 08:45 (BoatTrace — merge-tracks: checkmark bottom-right + unified apk timestamp)
...
| | Ui_General | App-lifecycle UX: back-to-exit guard, keep-screen-on wakelock, edge-to-edge rendering, WindowInsets, list normalization (ListOverlayScaffold, sort, swipe-to-delete, per-type custom sort fields, localized EN+FR) | 2026-06-08 16:43 | 2026-07-02 10:59 | active |
...
| | **BoatTrace** | **Boat movement tracking: record tracks from GPS fixes, persist, display on map with configurable render layers, GPX export/import with round-trip fidelity, track history UI, render preview indicator, idle-period marker snapshots (BoatMarker), auto-marker 🕐 pins at idle spots with transparency, resume/merge tracks** | **2026-06-15 21:43** | **2026-07-14 08:45** | **active** |
