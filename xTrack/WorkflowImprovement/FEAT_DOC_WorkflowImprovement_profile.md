<!-- scope: feature -->
# WorkflowImprovement — Feature Profile

| Field | Value |
|---|---|
| **Status** | active |
| **One-Liner** | xTrack #command system, git shortcuts, #now/#list rename, trigger syntax, fuzzy matching, bootstrap, and memory bake lifecycle |
| **Created** | 2026-06-03 00:00 |
| **Modified** | 2026-06-10 06:56 |
| **Subfeatures** | 18/18 complete (100%) |

## Subfeatures

| Subfeature | Status |
|---|---|
| Trigger phrase syntax redesign | ✅ |
| Feature file template | ✅ |
| Turn 1 protocol with intent gate + scope question | ✅ |
| Memory Bake event-driven triggers | ✅ |
| Hash-prefix command dispatcher (#) with fuzzy fallback | ✅ |
| xTrack bootstrap logic | ✅ |
| Active focus pivot ambiguity with cross-feature intercept | ✅ |
| #-only command system | ✅ |
| #instruction command | ✅ |
| Bare #todo/#instruction list mode | ✅ |
| Smart subfeature nesting for #todo | ✅ |
| #doc commands (bare, create, list, read, attach, detach) | ✅ |
| #doc list attachment column | ✅ |
| xTrack system review | ✅ |
...
- Post-merge reconcile xTrack/ across branches
- templates.md update to reflect normalized command set
- On-device verification of git shortcuts
