...
> **Digest floor — superseded 2026-09-22.** The corridor tracer this file designed was **removed with its
> code**: `app/src/main/java/ykws/android/maro/spatial/taut/` no longer exists. What it was, what it cost and
> why it went is written up in [`260922_FEAT_DOC_Route_taut-tracer.md`](../260922_FEAT_DOC_Route_taut-tracer.md),
> which carries this file's own measured figures with their provenance; the removal is
