...
## Docs
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_category-icon-mapping.md` — Category icon mapping
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_data-lookup-plan.md` — Data lookup plan
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_filter-design.md` — Filter design
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_fixes-discussion.md` — Fixes discussion
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_hexagon-fix-plan.md` — Hexagon fix plan
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_icon-gap-analysis.md` — Icon gap analysis
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_icon-warnings-plan.md` — Icon warnings plan
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_multi-source-normalization.md` — Multi-source normalization
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_readme.md` — Feature readme
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_reqs-formalized.md` — Requirements formalized
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_toggle-merge-design.md` — Toggle merge design
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_vessel-filter-design.md` — Vessel size restriction design
- `xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_vessel-size-filtering.md` — Vessel size filtering
...
- [`xTrack/RegulatedZones/260612_FEAT_PLN_RegulatedZones_data-format-redesign.md`](260612_FEAT_PLN_RegulatedZones_data-format-redesign.md) — Data format redesign proposal (no backward compat)
